...
RSpec.describe "/people", type: :request do
  requestsSetup object: :create_income,
  ...
  let(:invalid_attributes) {
    ...
    # build(:income).to_params ssn: "9208211"  # bad param
  }
  let(:new_attributes) {
    skip("Add one or more hash of attributes valid for your model")
    # build(:income_sample).to_params.slice(*%i[last_name first_name])
  }
